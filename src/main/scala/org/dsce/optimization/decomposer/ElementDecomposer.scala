...
import org.dsce.parser.graph.{Graph, HyperTree}
import org.dsce.parser.query.Query
import org.dsce.parser.remover.Element
import org.dsce.util.ExamplePattern.PatternName
import org.dsce.util.{ExamplePattern, GraphBuilder}
import org.dsce.{LogAble, TestAble}
import org.dsce.parser.graph.{Graph, HyperTree}
import org.dsce.parser.query.Query
import org.dsce.parser.remover.Element
import org.dsce.util.{ExamplePattern, GraphBuilder}
