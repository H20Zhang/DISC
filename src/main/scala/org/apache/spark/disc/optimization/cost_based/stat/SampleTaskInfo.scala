...
case class SampleParameterTaskInfo(prevHyperNodes: Set[Int],
  ...
  val sampleQuery: Seq[Schema] = prevHyperNodesSchemas
  ...
  //sampled Relations
  var sampledRelationSchema: Schema = {
    Schema.tempSchemaWithAttrIds(commonAttrIDs.toArray)
  }

  //gen test related Parameters
  val testQuery: Seq[Schema] = {
