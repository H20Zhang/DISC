...
import org.apache.spark.disc.Stage
import org.apache.spark.disc.deprecated.optimization.subgraph.remover.{
  Element,
  SymmetryBreakingRule
}
import org.apache.spark.disc.testing.ExamplePattern.PatternName.PatternName
import org.apache.spark.disc.util.{GraphBuilder, QueryBuilder}
