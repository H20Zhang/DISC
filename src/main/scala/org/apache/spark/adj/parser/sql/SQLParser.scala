package org.apache.spark.adj.parser.sql


//copyright https://scala-lms.github.io/tutorials/query.html
class SQLParser extends SQLAST {
...
//  override type Table = this.type

  override def Scan(tableName: String, schema: Option[Schema], delim: Option[Char]): Scan = {
    Scan(tableName, schema.getOrElse(Schema("")), delim.getOrElse(','), true)
  }
}