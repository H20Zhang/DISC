...
import org.apache.spark.adj.utils.testing.HCubeTester
import org.scalatest.{BeforeAndAfterAll, FunSuite}

class ADJMainTest extends FunSuite with BeforeAndAfterAll {
...
//    Factorize
    val commands =
      s"-q solarSquare -t 43200 -d ${dataAdress} -c Count -m ${Method.MergedHCube}"
