    ...
    kList.foreach { i =>
      {
        ...
        println(
          s"edge: ${sampledPattern.rawEdgeSize}, sampledEdge: ${sampledPattern.sampledRawEdgeSize}, ratio: ${sampledPattern.sampledRawEdgeSize.toDouble / sampledPattern.rawEdgeSize}"
        )
        query.zip(realSizes).map { f =>
